  ...
  return (
    <div className='review-form'>
      <div className="form-control score-container">
        ...
        <label className="radio-container">
          <input type="radio" value = "very_satisfield" name="review" required checked = {data.review === "very_satisfield"} onChange={(e) => uptadeFieldHandler("review", e.target.value)}/>
          <BsFillEmojiHeartEyesFill/>
      ...
      <div className="form-control">
        ...
        <textarea name="comment" id="comment" placeholder='Conte como foi a sua experiência com o produto...' required
         value = {data.comment || ""}
         onChange={(e) => uptadeFieldHandler("comment", e.target.value)}></textarea>
      </div>
    </div>
  )
}
